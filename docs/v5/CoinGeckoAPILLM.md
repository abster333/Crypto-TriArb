...
<Update label="November 2025">
  ## GT Community Data for more Pools Endpoints plus Farcaster and Zore Social URL Support
  ...
  **New fields surfaced:**
  ...
  ```json JSON highlight={4-6} theme={null}
  ...
          },
  ...
  * [New Pools List](/reference/latest-pools-list) — `/onchain/new_pools`
  ...
  ```json JSON highlight={2-3} theme={null}
  ...
        "discord_url": null,
        "farcaster_url": null,
        "zora_url": null,
